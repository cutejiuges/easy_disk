...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.SignTime = field.NewTime(tableName, "sign_time")
...
type user struct {
	...
	Password   field.String // 加盐的用户密码
	Email      field.String // 用户绑定的邮箱
	Phone      field.String // 绑定的手机号
	Profile    field.String // 用户属性
	Status     field.Int8   // 账户状态
	SignTime   field.Time   // 账户注册时间
	LastActive field.Time   // 最晚活跃时间
...
func (u *user) updateTableName(table string) *user {
	...
	u.SignTime = field.NewTime(table, "sign_time")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["sign_time"] = u.SignTime
