...
func (p *DiskApiServiceClient) Ping(ctx context.Context, req *disk_common.PingRequest) (r *disk_common.PingResponse, err error) {
	var _args DiskApiServicePingArgs
	_args.Req = req
	var _result DiskApiServicePingResult
...
func NewDiskApiServiceProcessor(handler DiskApiService) *DiskApiServiceProcessor {
	...
	self.AddToProcessorMap("Ping", &diskApiServiceProcessorPing{handler: handler})
...
type diskApiServiceProcessorPing struct {
	handler DiskApiService
}

func (p *diskApiServiceProcessorPing) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := DiskApiServicePingArgs{}
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := DiskApiServicePingResult{}
	var retval *disk_common.PingResponse
...
type DiskApiServicePingArgs struct {
	Req *disk_common.PingRequest `thrift:"req,1"`
}

func NewDiskApiServicePingArgs() *DiskApiServicePingArgs {
	return &DiskApiServicePingArgs{}
}

func (p *DiskApiServicePingArgs) InitDefault() {
}

var DiskApiServicePingArgs_Req_DEFAULT *disk_common.PingRequest

func (p *DiskApiServicePingArgs) GetReq() (v *disk_common.PingRequest) {
	if !p.IsSetReq() {
		return DiskApiServicePingArgs_Req_DEFAULT
	}
	return p.Req
}

var fieldIDToName_DiskApiServicePingArgs = map[int16]string{
	1: "req",
}

func (p *DiskApiServicePingArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *DiskApiServicePingArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DiskApiServicePingArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *DiskApiServicePingArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *DiskApiServicePingArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *DiskApiServicePingArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *DiskApiServicePingArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("DiskApiServicePingArgs(%+v)", *p)

}

type DiskApiServicePingResult struct {
	Success *disk_common.PingResponse `thrift:"success,0,optional"`
}

func NewDiskApiServicePingResult() *DiskApiServicePingResult {
	return &DiskApiServicePingResult{}
}

func (p *DiskApiServicePingResult) InitDefault() {
}

var DiskApiServicePingResult_Success_DEFAULT *disk_common.PingResponse

func (p *DiskApiServicePingResult) GetSuccess() (v *disk_common.PingResponse) {
	if !p.IsSetSuccess() {
		return DiskApiServicePingResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_DiskApiServicePingResult = map[int16]string{
	0: "success",
}

func (p *DiskApiServicePingResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *DiskApiServicePingResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_DiskApiServicePingResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *DiskApiServicePingResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *DiskApiServicePingResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *DiskApiServicePingResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *DiskApiServicePingResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("DiskApiServicePingResult(%+v)", *p)
