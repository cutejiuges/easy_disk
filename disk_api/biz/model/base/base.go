...
type Base struct {
	Extra map[string]string `thrift:"extra,1,optional" form:"extra" json:"extra,omitempty" query:"extra"`
}
...
type BaseResp struct {
	...
	Extra      map[string]string `thrift:"extra,255,optional" form:"extra" json:"extra,omitempty" query:"extra"`
}
