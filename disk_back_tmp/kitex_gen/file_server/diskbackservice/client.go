...
func (p *kDiskBackServiceClient) UploadFile(ctx context.Context, req *file_server.UploadFileRequest, callOptions ...callopt.Option) (r *file_server.UploadFileResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.UploadFile(ctx, req)
}

func (p *kDiskBackServiceClient) QueryFileInfo(ctx context.Context, req *disk_common.QueryFileInfoRequest, callOptions ...callopt.Option) (r *file_server.QueryFileInfoResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.QueryFileInfo(ctx, req)
}

func (p *kDiskBackServiceClient) DownloadFile(ctx context.Context, req *disk_common.DownloadFileRequest, callOptions ...callopt.Option) (r *file_server.DownloadFileResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.DownloadFile(ctx, req)
}

func (p *kDiskBackServiceClient) EditFileInfo(ctx context.Context, req *disk_common.EditFileInfoRequest, callOptions ...callopt.Option) (r *file_server.EditFileInfoResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.EditFileInfo(ctx, req)
}

func (p *kDiskBackServiceClient) DeleteFile(ctx context.Context, req *disk_common.DeleteFileRequest, callOptions ...callopt.Option) (r *file_server.DeleteFileResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
